...
<nav aria-label="<?= lang('Pager.pageNavigation') ?>">
  <ul class="pagination" id="paginationBDSD">
    ...
    <li class="page-item">
      <a href="<?= $pager->getPrevious() ?>" aria-label="<?= lang('Pager.previous') ?>" class="page-link">
        <span aria-hidden="true"><img src="<?php echo base_url('public/images/iconDown_in1.png');?>" alt=""></span>
      </a>
    </li>
    <?php endif ?>
    ...
    <li class="page-item">
      <a href="<?= $pager->getNext() ?>" aria-label="<?= lang('Pager.next') ?>" class="page-link">
        <span aria-hidden="true"> <img src="<?php echo base_url('public/images/iconDown_in.png');?>" alt=""></span>
      </a>
    </li>
    <!-- <li class="page-item">

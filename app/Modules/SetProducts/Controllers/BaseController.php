...
use App\Modules\SetProducts\Models\SetProductsModels as SetProductsModels;
use App\Modules\Products\Models\ProductsModels as ProductsModels;
use App\Modules\Promotion\Models\PromotionModels as PromotionModels;
...

{
	...
	public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
	{
		...
		$this->promotionModels = new PromotionModels($logger);
		// print_r($this->dataUserAuthen);die;
		$this->setProductsModels = new SetProductsModels($logger);
		...
		// if($this->uri['0'] == ''){
		// 	header("Location: ".base_url('/san-pham/danh-sach-san-pham'));
		// 	die;
		// }

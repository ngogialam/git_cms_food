...
use App\Modules\Methods\Models\MethodsModels as MethodsModels;
use App\Modules\Products\Models\ProductsModels as ProductsModels;
use App\Modules\Reviews\Models\ReviewsModels as ReviewsModels;
...

{
	...
	public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
	{
		...
		$this->methodsModels = new MethodsModels($logger);
		$this->productModels = new ProductsModels($logger);
		$this->reviewsModels = new ReviewsModels($logger);

...
use App\Modules\Category\Models\CategoryModels as CategoryModels;
...

{
	...
	public function initController(\CodeIgniter\HTTP\RequestInterface $request, \CodeIgniter\HTTP\ResponseInterface $response, \Psr\Log\LoggerInterface $logger)
	{
		...
		$this->categoryModels = new CategoryModels($logger);
		$this->promotionModels = new PromotionModels($logger);
		$this->productsModels = new ProductsModels($logger);

                ...
                <h2><?php echo $title; ?></h2>
                    <form action="" id="form-create-user" method="POST">
                        <div class="form-group row pdn">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="phoneLogin" disabled class="form-control checkExistPhone" id="phoneLogin" value="<?= $detailUser['USERNAME'] ?>" onkeypress="return isNumber(event)" placeholder="Số điện thoại đăng nhập" value="">
                        ...
                        <div class="form-group row pdn">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="fullName" class="form-control checkCharacter" id="fullName" placeholder="Tên người dùng" value="<?= $detailUser['NAME'] ?>">
                        ...
                        <div class="form-group row pdn">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="dob" class="form-control datePicker" id="dob" placeholder="Ngày sinh" value="<?= $detailUser['DOB'] ?>">
                        ...
                        <div class="form-group row pdn">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="email" class="form-control" id="email" placeholder="Email" value="<?= $detailUser['EMAIL'] ?>">
                                <span class="error_text" ></span>
                            </div>
                        </div>
                                ...
                                <select class="form-control chosen-select " id="groupUser" name="groupUser">
                                    ...
                                    <?php
                                        if(!empty($listGroupUser)){
                                            ...
                                            ?> 
                                            <option <?php echo ($detailUser['GROUP_ID'] == $groupUser['ID']) ? 'selected' : '' ?> value="<?= $groupUser['ID'] ?>"><?= $groupUser['NAME'] ?></option>
                                        <?php endforeach; } ?>
                                </select>
                        ...
                        <div class="form-group row pdn">
                            ...
                            <div class="col-sm-9">
                                <select class="form-control chosen-select " id="status" name="status">
                                    <option <?= ($detailUser['STATUS'] == 1) ? 'selected' : ''; ?> value="1">Hoạt động</option>
                                    <option <?= ($detailUser['STATUS'] == 0) ? 'selected' : ''; ?> value="0">Không hoạt động</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row text-right">
                            <div class="col-sm-12">
                                ...
                                <button type="submit" id="btn-add-user" class="btn btn-primary btn-add-user">Chỉnh sửa </button>
                            </div>
                        </div>
                    </form>
                </div>

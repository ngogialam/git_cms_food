                ...
                <form action="" id="form-create-group-user" method="POST">
                    ...
                    <div class="form-group row pdn">
                        ...
                        <select class="form-control chosen-select " id="newsCate" name="newsCate">
                            ...
                            ?>
                                <option <?php echo ($news['NEWS_CATE_ID'] == $cate['ID']) ? 'selected' : ''; ?> value="<?= $cate['ID'] ?>"><?= $cate['NAME'] ?></option>
                    ...
                    <div class="form-group row pdn">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="newsTitle" class="form-control newsTitle" autocomplete="off"
                                id="newsTitle" placeholder="Tên bài viết" value="<?= $news['NEWS_TITLE'] ?>">
                    ...
                    <div class="form-group row pdn appendNewsThumbnail imgThumbnail">
                        ...
                        <label for="newsThumbnail">
                            <img for="newsThumbnail" id="newsThumbnailImg" class="newsThumbnailImg cursorPointer mgl20"
                                src="<?php
                                    echo (isset($news['NEWS_IMG']) && $news['NEWS_IMG'] != '' ) ? URL_IMAGE_SHOW.$news['NEWS_IMG'] : base_url('public/images_kho/btn-add-img.svg');
                                ?>" alt="">
                        </label>
                        <input type="file" style="display:none" name="newsThumbnail" class="imgDefault newsThumbnail"
                            ...
                            id="newsThumbnail" />
                        <input type="hidden" class="inputImgBs imgThumbnailNews" value="<?php echo $news['NEWS_IMG'] ?>" name="imgThumbnailNews">
                    </div>
                    ...
                    <div class="form-group row pdn">
                        ...
                        <div class="col-sm-9">
                                ...
                                <textarea name="newsSapo" class="newsSapo" id="newsSapo"><?php echo $news['NEWS_SAPO']; ?></textarea>
                    ...
                    <div class="form-group row pdn">
                        <label for="newsContent" class="col-sm-3 col-form-label"> Nội dung bài viết <span
                                style="color: red">(*)</span></label>
                        <div class="col-sm-9">
                            <textarea name="newsContent" class="newsContent" id="newsContent"><?php echo $news['NEWS_CONTENT']; ?></textarea>
                    ...
                    <div class="form-group row pdn">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control chosen-select " id="status" name="status">
                                <option <?php echo ($news['STATUS'] == 1) ? 'selected' : ''; ?> value="1">Hoạt động</option>
                                <option <?php echo ($news['STATUS'] == 0) ? 'selected' : ''; ?> value="0">Không hoạt động</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row text-right">
                        <div class="col-sm-12">
                            ...
                            <button type="submit" id="btn-add-news"
                                class="btn btn-primary btn-add-news">Sửa</button>
                        </div>
                    </div>
                </form>
            </div>

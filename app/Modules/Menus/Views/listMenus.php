                        ...
                        <div class="row searchBar">
                            <div class="form-group col-md-7 pdr-menu ">
                                <input type="text" value="<?php echo (isset($conditions['nameMenus'])) ? $conditions['nameMenus'] : '' ?>"
                                    name="nameMenus" class="form-control" placeholder="Tên menus">
                            </div>
                        ...
                        <div class="row mgbt searchBar">
                            <div class="form-group col-md-4 pdr-menu">
                                <div class="d-flex align-items-center">
                                    <div class="pr-1 mb-4 mb-xl-0">
                                        <button type="button" class="btn btn-success btn-icon-text" onclick="addMenus()">Thêm menus</button>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group col-md-8 pdl-menu">
                                <div class="d-flex align-items-center justify-content-md-end">
                                    ...
                                    <div class="pr-1 mb-4 mb-xl-0">
                                        <a class="btn btn-danger bth-cancel btn-icon-text" href="<?= base_url('/menus/danh-sach-menus') ?> ">Bỏ lọc</a>
                                    </div>
                                    <!-- <div class="pr-1 mb-4 mb-xl-0">
                                    ...
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr class="text-center">
                                                ...
                                                <th class="vertical text-bold" width="15%">Tên menus</th>
                                                <th class="vertical text-bold" width="15%">Danh mục</th>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Thêm menus</h4>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group row pdn">
                    <label for="nameCate" class="col-sm-3 col-form-label"> Tên menus <span
                            style="color: red">(*)</span></label>
                    <div class="col-sm-9">
                        <input type="text" onchange="checkExistMenu()" name="nameMenus" class="form-control nameMenus" autocomplete="off"
                            id="nameMenus" placeholder="Tên menus" value="<?= $post['nameMenus'] ?>">
                ...
                <div class="form-group row pdn">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="positionMenus" class="form-control positionMenus" onkeypress="return isNumber(event)" autocomplete="off"
                            id="positionMenus" placeholder="Thứ tự hiển thị" value="<?= $post['positionMenus'] ?>">
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success btn-ok saveMenus btnAddMenu" disabled>Thêm mới</button>
            </div>
        </div>
    </div>
</div>
